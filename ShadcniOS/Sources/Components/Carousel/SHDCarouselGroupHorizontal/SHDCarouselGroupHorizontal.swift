...
/// ## Discussion
///
/// `SHDCarouselGroupHorizontal` renders carousel items in a horizontal `ScrollView` with multiple
...
/// - `content`: A `@ViewBuilder` closure that takes an individual item and returns the view to display for that item.
///
